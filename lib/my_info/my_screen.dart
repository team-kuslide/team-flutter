...
import 'package:kuslide/my_info/detail_my_screen/my_writing.dart';
                    ...
                    child: Column(
                      children: [
                        ...
                        const ContentButton(
                          ...
                          content: "로그아웃",
                          contentSize: 30,
                          detailWidget: MyPageDataWidget(), // 로그아웃 위젯으로 바꿔야함
                        ),
                        SizedBox(height: screenHeight * 0.01),
                        const ContentButton(
                          ...
                          content: "회원탈퇴",
                          contentSize: 30,
                          detailWidget: MyPageDataWidget(), // 회원탈퇴 위젯으로 바꿔야함
                        ),
                      ],
                    ),
                  ),
